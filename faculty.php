<?php
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST")
   {
    ...
    if(!empty($gmail) && !empty($password) && !is_numeric($gmail) )
    {
       ...
       $query = "insert into faculty (fname, lname, gender, cnum, address, email, pass, pin, class, subject) values('$first_name', '$last_name', '$Gender', '$num', '$address', '$gmail', '$password', '$pincode', '$class', '$subject')";
...
<div style=";"; > <img src="logo.png"></div>
